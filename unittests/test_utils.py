...
class TestUtils(unittest.TestCase):
    ...
    def test_get_df_filter_by_framework(self):
        data = {'rank': [5, 3, 1], 'dataset': ['D', 'A', 'A'], 'framework': ['A', 'A', 'A']}
        expected_df = pd.DataFrame(data) 
    ...
    def test_clean_up_framework_names(self):
        expected_names = pd.Series(['AutoGluon', 'AutoGluon v0.1', 'AutoGluon v0.2', 'AutoGluon v0.3',
                                    'AutoGluon', 'AutoGluon v0.1', 'AutoGluon v0.2', 'AutoGluon v0.3'])
