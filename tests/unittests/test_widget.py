...
class TestWidget(unittest.TestCase):
    ...
    @mock.patch("src.autogluon_dashboard.scripts.widget.Widget._create_selectwidget")
    ...
    @mock.patch("src.autogluon_dashboard.scripts.widget.Widget._create_numberwidget")
    ...
    @mock.patch("src.autogluon_dashboard.scripts.widget.Widget._create_togglewidget")
